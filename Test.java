...
public class Test {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            element1 =new JTextField(12);
            element2=new JTextField(12);
            ...
            JCheckBox cb50=new JCheckBox(new TipAction(model,0.50d));
          //  JCheckBox cbCustom = new JCheckBox(new CustomTipAction(model, custom));
           ...
           // bg.add(cbCustom);
            ...
            btnCalculate.setMargin(new Insets(10, 10, 10, 15));
            ...
            btnCalculate.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (tipPercentage > 0.0) {
                        ...
                        double termen1 =Double.parseDouble( element1.getText().trim());
                        double termen2=Double.parseDouble( element2.getText().trim());
                        double tipAmount = (termen1 *termen2)* tipPercentage;//*termen2;
                        double billTotal = termen1 + tipAmount;
